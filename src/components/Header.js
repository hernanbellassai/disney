...
import watch from "../assets/watchlist-icon.svg";
import ori from "../assets/original-icon.svg";
import serie from "../assets/series-icon.svg";
      ...
      {!username ? (
        ...
        <>
          <NavMenu>
            ...
            <a href="/home">
              <img src={ori} alt="home" />
              <span>ORIGINALS</span>
            </a>
            <a href="/home">
              <img src={serie} alt="home" />
              <span>SERIES</span>
            </a>
          </NavMenu>
